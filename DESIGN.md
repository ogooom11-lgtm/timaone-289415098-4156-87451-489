...
| `ClipboardWordsPanel` | لوحة نص الحافظة: كلمات قابلة للتحديد والسحب إلى الحقول (`clipboard_words_panel.dart`) |
| `TimaDropField` | غلاف حقل يستقبل نصاً بالإفلات ويُضاء أثناء السحب |
